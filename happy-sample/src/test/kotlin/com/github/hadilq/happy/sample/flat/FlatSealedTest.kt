...
class FlatSealedTest {
  ...
  @Test
  fun optionOneTest() {
    val result: HappyA = optionOne() elseIf {
      OptionOne {
        assert(true)
        return
      }
  ...
  @Test
  fun optionTwoTest() {
    val result: HappyA = optionTwo() elseIf {
      OptionOne {
        assert(false)
        return
      }
  ...
  private fun optionOne(): A = OptionOne

  private fun optionTwo(): A = OptionTwo(1, 2, 3)
}
