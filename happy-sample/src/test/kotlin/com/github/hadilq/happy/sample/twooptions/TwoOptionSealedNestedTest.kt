...
*/
package com.github.hadilq.happy.sample.twooptions

import com.github.hadilq.happy.annotation.Happy
import org.junit.Test

class TwoOptionSealedNestedTest {

  @Test
  fun optionOneTest() {
    val result: A.OptionOne = optionOne() elseIf { _, _, _ ->
      assert(false)
      return
    }
  }
  ...
  @Test
  fun optionTowTest() {
    val result: A.OptionOne = optionTwo() elseIf { _, _, _ ->
      assert(true)
      return
    }
  }
